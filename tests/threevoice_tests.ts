 ...
 *
 */
const threeVoices1 = createThreeVoicesTest(
  ['e5/2, e5', { stem: 'up' }],
 ...
 */
const threeVoices2 = createThreeVoicesTest(
 ...
 *
 */
const threeVoices3 = createThreeVoicesTest(
...
function autoRestTwoVoices(options: TestOptions): void {
