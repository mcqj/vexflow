...
export function createViteConfig({ entry, minify, versionInfo, watch = false }) {
    ...
    plugins: [
      {
        ...
        transform(code, id) {
          ...
          return { code: transformed.toString(), map: transformed.generateMap({ hires: true }) };
        },
      },
      {
        ...
        load(id) {
          return id === '\0virtual:vexflow-entry' ? `export { default } from ${JSON.stringify(input)};` : undefined;
        },
      },
    ],
    build: {
